...
#
# Script generated by Vivado on Mon Mar 16 15:04:33 KST 2026
...
#
# Usage        : fir_rrc.sh
#                fir_rrc.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_rrc.sh [-reset_run]
#                fir_rrc.sh [-reset_log]
#                fir_rrc.sh [-help]
#
...
# script info
echo -e "fir_rrc.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_rrc.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L fir_compiler_v7_2_23 -L secureip -L xpm --snapshot fir_rrc xil_defaultlib.fir_rrc -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fir_rrc -key {Behavioral:sim_1:Functional:fir_rrc} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fir_rrc.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fir_rrc.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fir_rrc.sh [-help]\n\
Usage: fir_rrc.sh [-step]\n\
Usage: fir_rrc.sh [-lib_map_path]\n\
Usage: fir_rrc.sh [-reset_run]\n\
Usage: fir_rrc.sh [-reset_log]\n\
Usage: fir_rrc.sh [-keep_index]\n\
Usage: fir_rrc.sh [-noclean_files]\n\n\
