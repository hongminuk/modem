...
add_wave -radix dec /tb_preamble_correlator/in_i
add_wave -radix dec /tb_preamble_correlator/in_q
add_wave /tb_preamble_correlator/in_valid
add_wave /tb_preamble_correlator/in_ready
add_wave_divider "Correlation Output"
add_wave -radix dec /tb_preamble_correlator/corr_i
add_wave -radix dec /tb_preamble_correlator/corr_q
