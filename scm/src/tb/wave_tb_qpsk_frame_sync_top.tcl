...
add_wave -radix bin /tb_qpsk_frame_sync_top/tx_bits
...
add_wave -radix dec /tb_qpsk_frame_sync_top/dut/tx_mod_i
add_wave -radix dec /tb_qpsk_frame_sync_top/dut/tx_mod_q
add_wave /tb_qpsk_frame_sync_top/dut/tx_mod_valid

add_wave_divider "TX: Frame Builder"
add_wave -radix dec /tb_qpsk_frame_sync_top/dut/frame_i
add_wave -radix dec /tb_qpsk_frame_sync_top/dut/frame_q
add_wave /tb_qpsk_frame_sync_top/dut/frame_valid

add_wave_divider "TX: After RRC FIR"
add_wave -radix dec /tb_qpsk_frame_sync_top/tx_out_i
add_wave -radix dec /tb_qpsk_frame_sync_top/tx_out_q
add_wave /tb_qpsk_frame_sync_top/tx_out_valid

add_wave_divider "RX: After Matched Filter + Downsample"
add_wave -radix dec /tb_qpsk_frame_sync_top/dut/rx_dn_i
add_wave -radix dec /tb_qpsk_frame_sync_top/dut/rx_dn_q
add_wave /tb_qpsk_frame_sync_top/dut/rx_dn_valid

add_wave_divider "RX: Correlator (after bug fix)"
add_wave -radix dec /tb_qpsk_frame_sync_top/dut/corr_i
add_wave -radix dec /tb_qpsk_frame_sync_top/dut/corr_q
...
add_wave -radix bin /tb_qpsk_frame_sync_top/rx_bits
