...
add_wave -divider "TX: Modulator (latest)"
...
add_wave -divider "TX: Frame Builder"
...
add_wave -divider "TX: After RRC FIR"
...
add_wave -divider "RX: After Matched Filter + Downsample"
...
add_wave -divider "RX: Correlator (after bug fix)"
...
add_wave -divider "RX: Demodulator (latest)"
