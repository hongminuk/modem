...
add_wave -divider "Payload Input"
add_wave -radix decimal /tb_frame_builder/in_i
add_wave -radix decimal /tb_frame_builder/in_q
add_wave /tb_frame_builder/in_valid
add_wave /tb_frame_builder/in_ready
add_wave -divider "Frame Output"
add_wave -radix decimal /tb_frame_builder/out_i
add_wave -radix decimal /tb_frame_builder/out_q
add_wave /tb_frame_builder/out_valid
add_wave /tb_frame_builder/out_ready
add_wave -divider "Internal State"
