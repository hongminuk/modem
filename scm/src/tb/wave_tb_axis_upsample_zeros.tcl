...
add_wave -radix dec /tb_axis_upsample_zeros/in_i
add_wave -radix dec /tb_axis_upsample_zeros/in_q
add_wave /tb_axis_upsample_zeros/in_valid
add_wave /tb_axis_upsample_zeros/in_ready
add_wave_divider "Upsampled Output"
add_wave -radix dec /tb_axis_upsample_zeros/out_i
add_wave -radix dec /tb_axis_upsample_zeros/out_q
